...
namespace Week9.Controllers
{
    ...
    public class SourceController : ControllerBase
    {
        ...
        [HttpPost]
        public ActionResult ReservationTaken([FromBody] Host host, int tableNumber, int reservationNumber)
        {
            ReservationTakenEvent rt = new ReservationTakenEvent();
            rt.TableNumber = tableNumber;
            rt.ReservationNumber = reservationNumber;
            rt.TimeStamp = DateTime.Now;

            _eventBus.PublishEvent<ReservationTakenEvent>("reservationTaken", rt);
